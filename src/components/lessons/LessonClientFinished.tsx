...
const LessonClientFinished = ({ lesson, session, teacher, student }: Props) => {
      ...
      <div className="flex flex-col items-center justify-center mt-10">
        <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-md p-4">
          ...
          <div className="mb-4">
            ...
            <button onClick={toggleRatingModal} className="w-full px-4 py-2 text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg focus:ring-4 focus:ring-indigo-300 focus:outline-none">
              Ohodnotiti učitele
            </button>
            <RatingPopup isOpen={isRatingModalOpen} onClose={toggleRatingModal} teacherId={teacher.id} studentId={student.id}/>
        </div>
      </div>
    );
...
export default LessonClientFinished;